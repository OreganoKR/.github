<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=F0E6D6&height=250&section=header&text=🌿Oregano&fontSize=90&fontAlign=70&fontAlignY=40&fontColor=2F4F4F&animation=fadeIn" style="width: 100%; height: auto;" />
</p>
...
| :------------------------------------- | :------------------------------------- | :------------------------------------- |
| ![메인정보페이지](./혜택정보.png)     | ![구인구직페이지](./구인구직.png)     | ![혜택정보페이지](./메인정보.png)     |
| - 구직 종류 별 임금 평균과 인구 수<br>- 장애인 전체 인구 수 및 취업자 비율 | - 이력서 제출을 위한 취업 사이트 연결<br>- 각 지역, 구인 형태 별 일자리 검색 | - 현재 장애인 고용 공단에서 진행 중인 혜택 정보 제공<br>- 한국장애인고용공단 지역별 정보 표시 |
